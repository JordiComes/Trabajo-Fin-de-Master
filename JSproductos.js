...
/*const productosencarrito = document.querySelectorAll('.borrar-catalogo');*/
...
function cargarEventListeners() {
  ...
  finalizarcompra.addEventListener('click', function (){
    location.href="/TFM/php/finalizarcompra.php"
  });
...
function eliminarCatalogoLocalStorage(catalogo) {
  ...
  catalogosLS.forEach(function (producto, indice){
    if(producto.id === catalogo) {
      catalogosLS.splice(indice, 1);
    }
  });
